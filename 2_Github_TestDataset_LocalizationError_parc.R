...
working.directory <- "C:/Users/degrootel/Documents/Parc Stopover/"
...
source("EcolEvol.Manuscript_Optimizing.Trilateration/4_Functions_RSS.Based.Localizations.R")

## Bring in 3 Needed files - Test Information, RSS values, and Node Information - change file names in " " as needed
test.info <- read.csv("parcstopover/TestInfo.csv", header = T)[,-1]
...
nodes$NodeId<-as.factor(nodes$NodeId)
str(nodes)
...
#> coef(nls.mod)
#a             S             K 
#3.912269e+01  9.837001e-03 -1.070423e+02 
##******** Define Variables - replace values below with user specified values ********##  
a <- 3.912269e+01
S <- 9.837001e-03
K <- -1.070423e+02 
